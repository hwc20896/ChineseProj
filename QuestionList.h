...
namespace QuestionList{
    ...
    //  難度：中等
    QTMC* Question10 = new QTMC("我國古代有很多計量單位，比如詩句\n\"黃河遠上白雲間，一片孤城萬仞山\"中\n的\"仞\"，一仞約相當於：",{"一個成年人的高度","成年人一臂的長度"},Option::B);

    //  難度：難偏地獄
    QTMC* Question11 = new QTMC("下列哪一句詩描寫的場景\n最適合採用水墨畫來表現？",{"落霞與孤鶩齊飛，\n秋水共長天一色。","返景入深林，\n複照青苔上。","孤舟蓑笠翁，\n獨釣寒江雪。","接天蓮葉無窮碧，\n映日荷花別樣紅。"},Option::C);
    ...
    //  難度：簡單
    QTMC* Question16 = new QTMC("假如你的一首五絕詩被雜誌社採用，\n按照正文部分每字5元來計算，\n你應得多少稿費？",{"50元","100元","200元"},Option::B);

    //  難度：難偏地獄
    QTMC* Question17 = new QTMC("下面哪個字常用作表示\n順序的第五位元？",{"戊","戍","戌"},Option::A);

    //  難度：中等偏簡單
    QTMC* Question18 = new QTMC("諸子百家中名家的特點是注重邏輯辯證，\n以下哪個典故能體現名家的這一特點？",{"白馬非馬","指鹿為馬"},Option::A);
    ...
    //  難度：中等
    QTMC* Question36 = new QTMC("下面哪句話出自《孟子》？",{"\"水能載舟，亦能覆舟\"","\"先天下之憂而憂，\n後天下之樂而樂\"","\"民惟邦本，本固邦寧\"","\"獨樂樂，與人樂樂，孰樂？\""},Option::D);
